// Following is the constant data that is used throghout the game update gameplay.
...
const GAME = {
  ...
  SOURCE_CODE_URL: "https://github.com/ivcained/jesse-squats",
};
...
const GROUND = {
  ...
  // Can not use these const values during init so if any of those values change, we need to change it here as well, be careful and mindful, meditate.
...
const OBSTACLES = {
  ...
  // This modifies the chance of a an obstacle spawning
  // Only applies when not using a custom art
